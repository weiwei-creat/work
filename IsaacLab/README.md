...
> SAGE local note: this vendored Isaac Lab copy contains compatibility patches for Isaac Sim 5.1 / Python 3.11 in this repository. Use `server/README.md` for the SAGE-specific IsaacLab setup and launch commands.
